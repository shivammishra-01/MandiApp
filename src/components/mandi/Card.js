  ...
  return (
    <div className="mt-5">
      <header className={cardstyle.header}>
        <h1 className="front-card">ℕ𝔼𝕎𝕃𝕐 𝔸𝔻𝔻𝔼𝔻 𝕃𝕀𝕍𝔼𝕊𝕋𝕆ℂ𝕂 𝕆𝔽 ℂℝ𝕆ℙ𝕊</h1>
        <p>
          <span>
      ...
      <header className={cardstyle.header}>
        <h1 className="front-card">ℕ𝔼𝕎𝕃𝕐 𝔸𝔻𝔻𝔼𝔻 𝕃𝕀𝕍𝔼𝕊𝕋𝕆ℂ𝕂 𝕆𝔽 𝔸ℕ𝕀𝕄𝔸𝕃𝕊</h1>
        <p>
          <span>
        ...
        {aniaml.map((Element, index) => {
          return (
            <div key={index} className={cardstyle.product}>
              <picture>
                <img
                  src="https://source.unsplash.com/random/600x400?cow"
                  alt=""
                />
              </picture>
              <div className={cardstyle.detail}>
      ...
      <header className={cardstyle.header}>
        <h1 className="front-card">ℕ𝔼𝕎𝕃𝕐 𝔸𝔻𝔻𝔼𝔻 𝕃𝕀𝕍𝔼𝕊𝕋𝕆ℂ𝕂 𝕆𝔽 𝔽𝔼ℝ𝕋𝕀𝕃𝕀ℤ𝔼ℝ𝕊</h1>
        <p>
          <span>
