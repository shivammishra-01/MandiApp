...
export default function Signup(props) {
      ...
      if (name === "") {
        ...
        try {
          const res = await axios.post(
            "http://localhost:8080/api/farmer",
            farmer,
  ...
  return (
    <div className="container mt-3 d-flex justify-content-center">
      <div
        className={`${signupcss.registrationForm} card shadow`}
        style={{ width: "60rem" }}
      >
                  ...
                  <div className="col-lg-6">
                    <div className="mb-3">
                      <div className={`d-flex ${signupcss.buttonLine}`}>
                        ...
                        <input
                          type="text"
                          className={`form-control ${signupcss.formControl}`}
                          id="name"
                          name="name"
                          autoComplete="off"
                          value={name}
                    ...
                    <div className="mb-3">
                      <div className={`d-flex ${signupcss.buttonLine}`}>
                        <i className="fa-solid fa-envelope mt-2 ps-2"></i>&nbsp;
                        <input
                          type="email"
                          className={`form-control ${signupcss.formControl}`}
                          id="email"
                          ...
                          onChange={(e) => {
                            ...
                            setFarmerid(e.target.value.split("@")[0]);
                          }}
                          placeholder="Email"
                        />
                      </div>
                    ...
                    <div className="mb-3">
                      <div className={`d-flex ${signupcss.buttonLine}`}>
                        <i className="fa-solid fa-mobile-screen-button mt-2 ps-2"></i>
                        &nbsp;
                        <input
                          type="number"
                          className={`form-control ${signupcss.formControl}`}
                    ...
                    <div className="mb-3">
                      <div className={`d-flex ${signupcss.buttonLine}`}>
                        ...
                        <input
                          ...
                          name="farmeradhar"
                          value={farmeradhar}
                          onChange={(e) => setFarmeradhar(e.target.value)}
                    ...
                    <div className="mb-3">
                      <div className={`d-flex ${signupcss.buttonLine}`}>
                        ...
                        <div className="password-toggle">
                          ...
                          />
                          <i
                            className={`fa-regular ${showpass.cpass}`}
